...
set(_vtk_installed_prefix "C:/Program Files/VTK/lib/cmake/vtk-8.1")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "C:/Program Files/VTK")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Program Files/VTK/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Program Files/VTK/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/toolkit/VTK/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/toolkit/VTK/build/lib")
  endif ()
endif()
